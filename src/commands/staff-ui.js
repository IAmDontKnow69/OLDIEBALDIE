...
module.exports = {
  ...
  execute: async (interaction) => {
    ...
    // Roles section header as an embed field, then the select menus below
    ...
    const rows = [
      controlRow,
      // Roles header field in embed plus select rows following
    ...
    // add a Roles field to the embed to visually separate the section
    embed.addFields({ name: 'Roles (use the select menus below to configure)', value: '\u200b' });
